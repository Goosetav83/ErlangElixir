...
get_station_min_test() -> %%%!!!!!
  ...
  M4 = pollution:add_value("Stacja 1", {{2023,3,27},{11,16,13}}, "PM10", 1, M3),

  ?assertMatch(10, pollution:get_station_min("Stacja 1", "PM10", M2)),
  ?assertMatch(5, pollution:get_station_min({1,1}, "PM10", M3)),
  ?assertMatch(1, pollution:get_station_min("Stacja 1", "PM10", M4)).
...
get_daily_mean_test() -> %%%!!!!!
  ...
  ?assertMatch(2500.0, pollution:get_daily_mean("PM10",{2023,3,28}, M9)). %%%!!!!! bylo 15 na date 27
...
get_area_mean_test() ->
  M = pollution:add_station("Stacja 1", {1,1}, pollution:add_station("Stacja 2", {1,2}, pollution:add_station("Stacja 3", {2,2}, pollution:add_station("Stacja 4", {0,1}, pollution:create_monitor())))),
  M1 = pollution:add_value("Stacja 1", {{2023,3,27},{11,16,10}}, "PM10", 10, M),
  M2 = pollution:add_value("Stacja 2", {{2023,3,27},{11,16,11}}, "PM10", 20, M1),
  M3 = pollution:add_value("Stacja 3", {{2023,3,27},{11,16,12}}, "PM10", 30, M2),
  M4 = pollution:add_value("Stacja 4", {{2023,3,27},{11,16,13}}, "PM10", 40, M3),
  M5 = pollution:add_value("Stacja 1", {{2023,3,27},{11,16,14}}, "PM25", 10, M4),
  ?assertMatch(15.0, pollution:get_area_mean("PM10", {1,1}, 1, M2)),
  ?assertMatch(20.0, pollution:get_area_mean("PM10", {1,1}, 2, M3)),
  ?assertMatch(20.0, pollution:get_area_mean("PM10", {1,2}, 1, M3)),
  ?assertMatch(25.0, pollution:get_area_mean("PM10", {2,2}, 4, M4)),
  ?assertMatch(10.0, pollution:get_area_mean("PM25", {1,1}, 1, M5)).

get_area_mean_fail_test() ->
  M = pollution:add_station("Stacja 1", {1,1}, pollution:add_station("Stacja 2", {1,2}, pollution:add_station("Stacja 3", {2,2}, pollution:add_station("Stacja 4", {0,1}, pollution:create_monitor())))),
  M1 = pollution:add_value("Stacja 1", {{2023,3,27},{11,16,10}}, "PM10", 10, M),
  M2 = pollution:add_value("Stacja 1", {{2023,3,27},{11,16,10}}, "PM10", 10, M),
  ?assertMatch({error, _}, pollution:get_area_mean("PM10", {1,1}, 1, M)),
  ?assertMatch({error, _}, pollution:get_area_mean("PM25", {1,1}, 1, M1)),
  ?assertMatch({error, _}, pollution:get_area_mean("PM10", {4,4}, 1, M2)).
